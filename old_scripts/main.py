...
def main():
    ...
    # ==========================================
    # FEATURE EXTRACTION & TOKENIZATION (Laptop Mode)
    # ==========================================
    ...
    # ==========================================
    # 3. TRAINING SETUP (Overnight Laptop Mode)
    # ==========================================
    ...
    # 3d. Training Arguments (Ambitious 7-Hour Overnight Run)
    training_args = Seq2SeqTrainingArguments(
        output_dir="./whisper-tiny-hindi-finetuned",
        per_device_train_batch_size=4,
        # <-- INCREASED: Effective batch size of 16 for better learning
        gradient_accumulation_steps=4,
        learning_rate=1e-5,
        warmup_steps=200,
        # <-- INCREASED: Rule of thumb is ~10% of max_steps
        max_steps=2000,
        # <-- INCREASED: 5x longer training time
        eval_strategy="steps",
        predict_with_generate=True,
        generation_max_length=225,
        # <-- INCREASED: Only save/evaluate 4 times during the night
        save_steps=500,
        eval_steps=500,  # so it spends more time training and less time testing
        logging_steps=50,
    ...
    # 4. EXECUTE TRAINING
    # ==========================================
    print("\nStarting Training! This will take a while on a CPU...")
    trainer.train()
